...
public class Logger {
    ...
    //TODO: factor out into standalone class amnd then refer it through ThreadLocal
    //Previously all these fields were of ThreadLocal type. ThreadLocal was removed because Screenshot capturing thread need an access to them.
    ...
    public static void startTest(final String fullTestName, final ITestResult testResult, final String testClassName, final String testName, final String brandName) {
        Logger.fullTestName = fullTestName;
        Logger.testResult = testResult;

        Logger.setDetailedName(testClassName, testName, brandName);

    }

    private static void setDetailedName(final String testClassName, final String testName, final String brandName) {
